...
let filteredData;
  ...
  return (
    <nav className="flex justify-between mb-10 items-center md:gap-x-0 gap-x-2">
      <Link to={`/`} className="flex sm:text-4xl text-lg items-center italic animate-pulse transition-all duration-1000 font-black tracking-tighter">myIG</Link>
      ...
      <div
        ...
        {currentUser &&
          <button
            className="font-semibold underline underline-offset-4 text-lg sm:text-xl md:text-2xl"
            type="submit"
